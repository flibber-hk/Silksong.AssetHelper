...
namespace Silksong.AssetHelper.CatalogTools
{
    ...
    internal static class Catalog
    {
        ...
        /// </summary>
        public static readonly string catalogFolder = Path.Combine(
        ...
        public static unsafe UnityEngine.Hash128 hash(byte[] catalogByteArray)
        {
        ...
        public static void writeCatalog(List<ContentCatalogDataEntry> locationEntries, string catalogId)
        {
            ...
            string catalogName = $"AssetHelper-{catalogId}";
            ...
            File.WriteAllBytes(Path.Combine(catalogFolder, $"{catalogName}.bin"), catalogBytes);
            File.WriteAllText(Path.Combine(catalogFolder, $"{catalogName}.hash"), outhash.ToString());
