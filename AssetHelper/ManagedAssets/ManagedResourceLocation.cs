...
/// <summary>
/// Like <see cref="ManagedAsset{T}"/>, but based on a <see cref="IResourceLocation"/> rather than a key.
/// </summary>
public class ManagedResourceLocation<T>(IResourceLocation location) : IManagedAsset
{
    /// <summary>
    /// The location loaded by this instance.
    /// </summary>
    public IResourceLocation Location { get; } = location;
    ...
    public AsyncOperationHandle<T> Handle =>
        _handle.HasValue
            ...
            : throw new InvalidOperationException(
                $"Addressable asset with location {Location.InternalId} must be loaded before accessing the handle!"
            );
